  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-64 bg-white shadow-md">
        ...
        <nav className="mt-4">
          <Link href="/dashboard" className="flex items-center py-2 px-4 bg-gray-200">
          ...
          <Link href="/withdraw" className="flex items-center py-2 px-4">
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            Withdraw
          </Link>
          <Link href="/settings" className="flex items-center py-2 px-4">
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="space-y-4 mb-6">
          <Link href="/deposit" className="block">
            <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
              ...
              <button className="bg-blue-500 text-white px-4 py-2 rounded">Deposit</button>
            </div>
          </Link>
          ...
          <Link href="/withdraw" className="block">
            <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
              ...
              <button className="bg-blue-500 text-white px-4 py-2 rounded">Withdraw</button>
            </div>
          </Link>
        </div>
